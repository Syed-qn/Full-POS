...
## Corpus Check
- 735 files · ~1,049,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8948 nodes · 32011 edges · 1144 communities detected
- Extraction: 32% EXTRACTED · 68% INFERRED · 0% AMBIGUOUS · INFERRED: 21698 edges (avg confidence: 0.5)
...
1. `Order` - 1004 edges
2. `Restaurant` - 977 edges
3. `Dish` - 906 edges
4. `Customer` - 872 edges
5. `Menu` - 871 edges
6. `Rider` - 808 edges
7. `Conversation` - 735 edges
8. `OrderItem` - 721 edges
9. `OrderStatus` - 718 edges
10. `CustomerAddress` - 710 edges
...
Cohesion: 0.03
Nodes (818): CartLineContext, CartService, normalize_note(), CartService — single owner of cart mutations for ordering.  All add / set-qty /, Apply a normalised kitchen note to an in-cart dish.          Strips politeness/a, Remove units of a dish from the cart., Delete ALL items from the cart.          Raises ValueError when *explicit* is Fa, Return structured cart lines with stable cart_item_id for LLM context (F64). (+810 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (616): Base, BatchPlanSettings, labels_from_batches(), Shared batch planning for preview (dry) and dispatch (live)., Return planned batches using the same greedy rules as dispatch., Map order_id -> preview label (A, B, …) for batches with 2+ orders., run_batch_plan(), OrderCandidate (+608 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (256): TokenBucketLimiter, ClaudeArbiter, ClaudeCompletionDetector, ClaudeConversationAgent, ClaudeDescriber, ClaudeExtractor, ClaudeForecastAdjuster, ClaudeIntentClassifier (+248 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (313): Audit System, Auto App-Invite on Rider Creation, COD Payment, audit/service.py:record_audit, cod/service.py (shift reconciliation), conversation/engine.py, coupons/models.py, coupons/service.py (+305 more)

### Community 4 - "Community 4"
Cohesion: 0.03
Nodes (234): BaseModel, _batch_id_for_order(), build_partner_delivery_data(), _eta_minutes(), get_partner_order_delivery(), get_partner_rider_location(), notify_partner_delivery_event(), notify_partner_delivery_transition() (+226 more)
...
Cohesion: 0.02
Nodes (144): ABC, _build_graph_payload(), CloudAPIProvider, Raise ValueError if X-Hub-Signature-256 header does not match body HMAC., Upload raw bytes to Meta media API; return the media_id., Fetch inbound media bytes from the Graph API (two-step: resolve the         temp, Upload raw bytes to Meta media API; return the media_id., Fetch inbound media bytes from the Graph API (two-step: resolve the         temp (+136 more)
...
Cohesion: 0.05
Nodes (164): _acquire_conversation_lock(), _add_dish_to_cart(), _advance_modify_to_confirm(), _aed(), _answer_dish_info(), _apply_confirmation_edit(), _apply_history_source_prefix(), _apply_note_to_existing_cart_item() (+156 more)
...
Cohesion: 0.02
Nodes (89): ExpoPushProvider, Expo Push API provider (production).  Sends a single push via https://exp.host/-, _get_fake_provider(), get_fake_push_provider(), get_geo_provider(), get_push_provider(), Push provider selection. ``APP_PUSH_PROVIDER`` = fake | expo., Singleton FakePushProvider so tests can read its ``sent`` list. (+81 more)

### Community 13 - "Community 13"
Cohesion: 0.03
Nodes (124): build_catalog_item_data(), CatalogReadError, CatalogWriteError, check_batch_request_status(), _collect_batch_errors(), _dish_retailer_id(), fetch_catalog_products(), format_meta_price() (+116 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (115): check_and_flag(), Refund-abuse velocity checks + auto-freeze.  Called after a complaint refund is, Count + sum refund credits to an account within the rolling window., Freeze the customer's wallet if refund velocity exceeds configured caps.      Re, refund_velocity(), AccountFrozen, InsufficientFunds, Wallet domain errors. (+107 more)

### Community 15 - "Community 15"
Cohesion: 0.03
Nodes (70): FakeForecastModel, Deterministic fake forecast model for service/worker/router tests., build_observations(), DishHourObservation, feature_vector(), Pure feature builder for demand forecasting (no DB, model-agnostic).  The servic, Group raw order items by (dish_id, date, dow, hour) and sum qty.      Each item, Mean qty across observations matching the (dish, dow, hour) bucket.      Returns (+62 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (50): Exception, geo_health(), get_meta_config(), invite_rider_to_app(), _meta_config_out(), patch_meta_config(), Diagnose delivery-distance accuracy in the live environment.      Without params, Read this restaurant's Meta/WhatsApp connection (token never returned). (+42 more)
...
Cohesion: 0.05
Nodes (60): Wallet ledger models (financial-grade, append-only).  Design (see docs/research/, Ticket, _aed(), _apply_category_map(), _category_of(), create_replacement_order(), create_ticket(), _customer_phone() (+52 more)
...
Cohesion: 0.04
Nodes (55): W1, W2, W4, Response-accuracy capability eval suite — 19 scenarios (W0).  All xfail evals ru, Add 2 lemon mints then 'remove 1 lemon mint'.  Today the engine either     dupli, make it 1 lakh' after adding lemon mint.  The engine today silently     accepts, A 'reaction' arrives as UNKNOWN type.  Today the engine falls through to     the, catlog' (common typo) is NOT in _MENU_KEYWORDS today, so it falls through     to (+47 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (49): _btn(), _conv(), _loc_msg(), _msg(), _seed_lemon_mint(), _seed_menu(), _seed_returning_with_saved_address(), test_ambiguous_match_sends_disambiguation_question() (+41 more)
...
Cohesion: 0.08
Nodes (29): calculate_fee(), delivery_fee_aed(), delivery_info_text(), fee_settings_from_restaurant(), _fmt_aed(), OutOfRadiusError, radius_km(), Canonical delivery-fee primitive (spec §1, CLAUDE.md non-negotiable rules).  Sin (+21 more)
...
Cohesion: 0.12
Nodes (30): _auth(), _seed_full_order(), test_api_advance_delivers_preparing_ping_immediately(), test_api_delete_order_returns_204_then_404(), test_api_order_detail_includes_dispatch_explain(), test_api_order_detail_returns_200(), test_api_order_detail_unknown_id_returns_404(), test_api_patch_address() (+22 more)
...
Cohesion: 0.16
Nodes (20): _seed(), _seed_soup_cart(), test_ambiguous_candidates_filtered_to_catalogue(), test_ambiguous_candidates_unfiltered_in_text_mode(), test_cart_query_shows_cart_not_catalogue(), test_catalog_cart_edit_at_confirmation_reshows_summary(), test_catalog_excludes_dish_logic(), test_catalog_excludes_nothing_in_text_mode() (+12 more)
...
Cohesion: 0.33
Nodes (13): _last_out(), _seed_big_catalogue(), _seed_many_categories(), test_big_menu_sends_category_picker_when_enabled(), test_big_menu_truncates_to_product_list_when_disabled(), test_category_list_paginates_when_many_categories(), test_category_paginates_within_category_over_30(), test_category_resolved_from_dish_when_mirror_null() (+5 more)
...
Cohesion: 0.19
Nodes (13): _get_or_create_active_menu(), get_partner_menu_sync_status(), PartnerMenuUpsertResult, patch_partner_menu_item(), _publish_menu_mirror(), queue_pos_menu_pull(), Partner menu push/pull helpers (Phase 3)., Fast path for sold-out / price tweaks. (+5 more)
...
Cohesion: 0.29
Nodes (9): test_add_dish(), test_add_dish_persists_meta_fields(), test_add_dish_rejects_sale_price_not_positive(), test_delete_dish(), test_delete_dish_with_order_history_archives(), test_duplicate_dish_number_409(), test_patch_dish_price_and_name(), test_toggle_availability() (+1 more)
...
Cohesion: 0.21
Nodes (11): _cite_tag(), grounding_block(), OKF lexical retrieval — find the concept docs most relevant to a customer messag, Drop YAML frontmatter — it burns budget without adding customer-facing facts., Truncate markdown body to ~max_chars, suffixing with ellipsis when clipped., Render retrieved OKF docs into a prompt-injectable grounding block., Top OKF docs for ``query``.      MULTILINGUAL: lexical (pg_trgm) similarity only, E-20 provenance tag — entity_id when pinned, else stable doc id. (+3 more)
...
Cohesion: 0.27
Nodes (11): _address_progress(), build_compact_summary(), _cart_snapshot(), maybe_compact_history(), _order_ref(), _phase_label(), Conversation history compaction for long-horizon returning customers (E-09).  Wh, Compact older messages when count exceeds ``threshold``.      Returns True when (+3 more)
...
Cohesion: 0.49
Nodes (10): _api_key(), _enable_partner(), _ready_order_with_address(), _seed_restaurant(), test_delivered_fires_webhook_with_cod(), test_dispatch_fires_rider_assigned_webhook(), test_get_delivery_poll_endpoint(), test_order_late_webhook_on_sla_breach() (+2 more)

### Community 113 - "Community 113"
Cohesion: 0.29
Nodes (7): _make_doc(), test_grounding_block_caps_at_four_docs(), test_grounding_block_cite_falls_back_to_doc_id(), test_grounding_block_cite_uses_entity_id(), test_grounding_block_header_cite_instruction(), test_grounding_block_total_char_budget(), test_grounding_block_truncates_long_body()
...
Cohesion: 0.44
Nodes (10): _btn(), _confirmed_four_item_order(), _conv(), _msg(), _seed_four_item_menu(), test_option_b_inline_post_order_remove_shows_confirm(), test_option_c_schema_has_order_line_actions(), test_t3_confirmation_inline_remove() (+2 more)
...
Cohesion: 0.31
Nodes (10): _conv(), test_build_history_uses_post_order_window(), test_buttons_history_omits_option_lists(), test_history_limit_varies_by_phase(), test_history_source_prefixes_and_cart_dedup(), test_jit_menu_included_when_flag_set(), test_jit_menu_omitted_by_default(), test_session_notes_injected_into_context() (+2 more)
...
Cohesion: 0.38
Nodes (9): _api_key(), test_pos_accepted_is_noop_when_already_confirmed(), test_pos_cancel_from_confirmed(), test_pos_cannot_advance_delivered_order(), test_pos_preparing_advances_from_confirmed(), test_pos_ready_from_preparing_single_step(), test_pos_ready_triggers_kitchen_to_ready(), test_pos_ready_with_available_rider_dispatches_without_error() (+1 more)

### Community 129 - "Community 129"
Cohesion: 0.31
Nodes (6): _seed(), test_add_item_ignores_invalid_sale_price(), test_add_item_uses_sale_price_when_set(), test_add_item_with_variant_snapshots_price(), test_add_item_without_variant_unchanged(), test_different_variants_are_separate_lines()
...
Cohesion: 0.27
Nodes (9): apply_meta_settings(), meta_connected(), meta_settings(), Per-restaurant Meta / WhatsApp connection config, stored in restaurants.settings, Return this restaurant's Meta connection config (empty strings if unset)., Merge a Meta-config patch into restaurant.settings; return the new snapshot., True when the restaurant has its own WhatsApp number + token configured., Return (phone_number_id, access_token) to send WhatsApp for this restaurant. (+1 more)
...
Cohesion: 0.47
Nodes (8): _make_order(), _seed_menu(), test_cancel_confirmed_order_returns_cancelled(), test_cancel_preparing_via_endpoint_is_cancelled_not_resold(), test_cancel_ready_order_is_422(), test_cancel_requires_auth(), test_cancel_unknown_order_is_404(), _token()
...
Cohesion: 0.44
Nodes (7): _conv(), _msg(), _placed_order_with_combo(), _seed_combo_menu(), test_cancel_dish_uses_last_placed_order_not_stale_draft(), test_only_lemon_mint_in_modify_sets_proposed_not_no_changes(), test_parse_cancel_dish_as_remove()

### Community 156 - "Community 156"
Cohesion: 0.22
Nodes (8): test_confirm_order_number_is_real(), test_observation_turn_after_add(), test_proceed_to_confirmation_is_engine_only(), test_single_add_reply_has_db_cart_tail(), test_strip_money_claims_empty_and_none(), test_strip_money_claims_preserves_non_money_text(), test_strip_money_claims_removes_aed_lines(), test_updated_note_reply_has_db_cart_tail()

### Community 157 - "Community 157"
Cohesion: 0.39
Nodes (8): _count_hits(), _do1_flags(), _extract_blocks(), _load_prompt_text(), main(), _never_always_without_spec(), Return (symbol, block_body) for known prompt constants., _render_checklist()

### Community 158 - "Community 158"
Cohesion: 0.22
Nodes (7): build_tier2_prompt(), parse_tier2_response(), Kitchen conversation digest — prompt + structured ground-truth renderer.  Senior, Tier 1: deterministic digest from persisted order/address fields., User turn for the tier-2 supplement call., Parse tier-2 LLM output into 0–2 supplement lines., render_structured_lines()
...
Cohesion: 0.43
Nodes (7): _api_key(), Phase 3: menu sync IN from POS., test_bulk_upsert_creates_pos_dishes(), test_bulk_upsert_updates_existing(), test_menu_changed_queues_pull(), test_menu_sync_status(), test_patch_availability()

### Community 175 - "Community 175"
Cohesion: 0.36
Nodes (4): _restaurant(), test_deliver_posts_signed_payload(), test_enqueue_creates_row_when_configured(), test_enqueue_skips_when_partner_disabled()
...
Cohesion: 0.25
Nodes (7): test_add_item_noted_reAdd_merges_note(), test_build_context_includes_cart_lines(), test_cart_service_build_structured_context(), test_cart_service_clear_explicit_only(), test_cart_service_set_note_normalizes_prefix(), test_modify_order_preserves_variant_and_notes(), test_set_item_qty_preserves_note()
...
Cohesion: 0.5
Nodes (7): _conv(), E-09 conversation history compaction., _seed_messages(), test_build_compact_summary_preserves_order_cart_address(), test_maybe_compact_creates_system_summary(), test_maybe_compact_noop_below_threshold(), test_maybe_compact_updates_conv_state()
...
Cohesion: 0.29
Nodes (7): build_claude_system(), build_identity(), build_phase_block(), Single source of truth for conversation system prompts (E-02, E-12, E-23).  Deep, Format identity + intent + meta-language blocks for any provider., Format the phase-specific prompt block; returns '' for unknown phases., Compose Claude conversation system prompt from shared constants (E-02).
...
Cohesion: 0.32
Nodes (7): apply_partner_settings(), partner_settings(), partner_webhook_config(), Partner (POS) integration config stored in ``restaurants.settings`` JSONB., Return partner-related settings with defaults., Merge partner config patch into restaurant.settings; return new snapshot., Return (target_url, secret) when partner webhooks are enabled, else (None, None)

### Community 197 - "Community 197"
Cohesion: 0.36
Nodes (7): _bg_color(), _font(), generate_dish_image(), Generate a dish image from its name.  The POS gives no product images, so we ren, Deterministic, mid-tone colour from the name (legible against white text)., Render the dish name onto a name-coloured square and return PNG bytes., _wrap()
...
Cohesion: 0.29
Nodes (1): test_meta_config_save_and_read()
...
Cohesion: 0.52
Nodes (6): _seed_confirmed_order(), _seed_dish(), test_finalize_confirmation_triggers_pos_push(), test_flush_pending_schedules_delivery(), test_partner_poll_and_ack(), test_push_order_creates_webhook_row()
...
Cohesion: 0.62
Nodes (6): _msg(), _seed_menu(), test_confirmation_add_item_actually_applies_and_reshows(), test_confirmation_no_action_reshows_real_summary(), test_confirmation_question_gets_answer_then_summary(), test_done_at_confirmation_with_address_reshows_summary_not_address()
...
Cohesion: 0.38
Nodes (6): ack_partner_order(), advance_kitchen_to(), apply_partner_kitchen_status(), build_partner_order_data(), list_partner_orders(), push_order_to_partner()
...
Cohesion: 0.38
Nodes (6): apply_at_confirm(), apply_coupon(), capture_on_deliver(), cod_due_aed(), recompute_order_total(), release_on_cancel()
...
Cohesion: 0.33
Nodes (1): Auxiliary prompt modules export expected constants and tagged sections.
...
Cohesion: 0.4
Nodes (5): HMAC-SHA256 signing for outbound partner webhooks., Verify ``X-Partner-Signature`` from an inbound request (future use)., Return the value for ``X-Partner-Signature`` (``sha256=<hex>``)., sign_body(), verify_signature()
...
Cohesion: 0.6
Nodes (3): _api_key(), test_partner_call_writes_audit_log(), test_partner_rate_limit_429()
...
Cohesion: 0.5
Nodes (3): Validate, apply, and audit a single order status transition.      The caller MUS, transition(), validate()
...
Cohesion: 0.5
Nodes (2): Re-enqueuing the same idempotency_key must NOT raise or duplicate — it     retur, test_enqueue_duplicate_idempotency_key_is_idempotent()
...
Cohesion: 0.83
Nodes (3): _msg(), test_ok_after_order_confirm_no_error_apology(), test_ok_after_resale_accept_no_error_apology()
...
Cohesion: 0.5
Nodes (1): test_error_apology_payload_mirrored_via_enqueue()
...
Cohesion: 0.83
Nodes (3): _print_new_webhooks(), _reset_sim_database(), run()
...
Cohesion: 0.5
Nodes (1): order POS sync fields: pos_order_id, pos_pushed_at, pos_push_status  Revision ID
...
Cohesion: 0.5
Nodes (1): partner_webhook_deliveries: outbound POS webhook queue  Revision ID: n7a8b9c0d1e
...
Cohesion: 0.5
Nodes (1): add dishes.pos_product_id  Stable external POS product id (e.g. Cratis posProduc
...
Cohesion: 0.5
Nodes (3): build_tier2_user_prompt(), Kitchen digest tier-2 LLM prompts.  Tier 1 (code) renders authoritative order ro, User turn for the tier-2 supplement call.
...
Cohesion: 0.5
Nodes (3): parse_pos_kitchen_status(), Map partner POS kitchen labels onto our order FSM targets., Normalize POS status string; raises ValueError if unknown.
...
Cohesion: 1.0
Nodes (2): test_list_orders_p95_under_budget_with_preview_cache(), _token_for()
...
Cohesion: 1.0
Nodes (2): _msg(), test_ok_after_kitchen_note_proceeds_to_address()
...
Cohesion: 1.0
Nodes (2): _lines_needing_spec(), main()
...
Cohesion: 1.0
Nodes (1): Router and completion-detection auxiliary prompts.  Small single-turn classifier

### Community 472 - "Community 472"
Cohesion: 1.0
Nodes (1): Marketing auxiliary prompts.

### Community 473 - "Community 473"
Cohesion: 1.0
Nodes (1): Menu, dish, segment, and forecast auxiliary prompts.  Non-conversation LLM tasks
...
Cohesion: 1.0
Nodes (1): Partial rider update — change status/duty, or edit name/phone profile fields.
...
Cohesion: 1.0
Nodes (1): Send a plain-text menu when no catalogue product is sendable yet (all in review)
...
Cohesion: 1.0
Nodes (1): Meta price format: number + space + ISO 4217 code (e.g. ``22.00 AED``).
...
Cohesion: 1.0
Nodes (1): True when WhatsApp can include this product in an interactive product_list.
...
Cohesion: 1.0
Nodes (1): Build items_batch ``data`` with Meta Commerce fields.      See https://developer

### Community 641 - "Community 641"
Cohesion: 1.0
Nodes (1): Surface per-item validation errors from an items_batch response.
...
Cohesion: 1.0
Nodes (1): Poll Meta for async items_batch ingestion status.

### Community 644 - "Community 644"
Cohesion: 1.0
Nodes (1): Wait until Meta finishes ingesting items_batch uploads (best-effort).
...
Cohesion: 1.0
Nodes (1): Manager turning a dish's WhatsApp catalogue presence on/off.
...
## Knowledge Gaps
- **1866 isolated node(s):** `Tests for Prometheus metrics (P7-T10).`, `Tests for app startup / shutdown lifespan and the /health endpoint.`, `/health returns {"status": "ok"} — confirms the lifespan completed startup.`, `Test outbox exponential backoff (P7-T1).`, `Verify countdown doubles: 10, 20, 40, 80, 160.` (+1861 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 425`** (2 nodes): `mapsNavigationUrl()`, `maps.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 426`** (2 nodes): `mockAuthedFetch()`, `App.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 427`** (2 nodes): `RiderTrackingScreen.tsx`, `RiderTrackingScreen()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 428`** (2 nodes): `OrderDetailDrawer.test.tsx`, `renderDrawer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 429`** (2 nodes): `TicketsScreen.tsx`, `onResolved()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 430`** (2 nodes): `renderProfile()`, `CustomerProfileScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 431`** (2 nodes): `renderScreen()`, `CustomerProfileScreen.wallet.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 432`** (2 nodes): `OrdersScreen.batch.test.tsx`, `order()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 433`** (2 nodes): `KPITile.tsx`, `KPITile()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 434`** (2 nodes): `ConfirmDialog()`, `ConfirmDialog.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 435`** (2 nodes): `RiderAddModal.tsx`, `RiderAddModal()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 436`** (2 nodes): `SideDrawer.tsx`, `SideDrawer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 437`** (2 nodes): `PosSyncButton.tsx`, `runSync()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 438`** (2 nodes): `DispatchKpiPanel()`, `DispatchKpiPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 439`** (2 nodes): `SectionBanner.tsx`, `SectionBanner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 440`** (2 nodes): `iso()`, `CountdownTimer.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 441`** (2 nodes): `TopBar.tsx`, `TopBar()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 442`** (2 nodes): `LiveOpsMap.tsx`, `LiveOpsMap()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 443`** (2 nodes): `PageHeader.tsx`, `PageHeader()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 444`** (2 nodes): `AppShell()`, `AppShell.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 445`** (2 nodes): `PrepCountdown.tsx`, `PrepCountdown()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 446`** (2 nodes): `StatusPill.tsx`, `StatusPill()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 447`** (2 nodes): `MetaConnectPanel.tsx`, `save()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 448`** (2 nodes): `PrepCountdown.test.tsx`, `inMin()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 449`** (2 nodes): `conv()`, `ConversationRow.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 450`** (2 nodes): `CountdownTimer()`, `CountdownTimer.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 451`** (2 nodes): `uploadPhoto()`, `DishEditModal.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 452`** (2 nodes): `onConfirm()`, `AppInviteModal.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 453`** (2 nodes): `QueryRefreshNote.tsx`, `QueryRefreshNote()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 454`** (2 nodes): `ConversationRow()`, `ConversationRow.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 455`** (2 nodes): `TicketDetailDrawer.tsx`, `TicketDetailDrawer()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 456`** (2 nodes): `Button()`, `Button.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 457`** (2 nodes): `Spinner.tsx`, `Spinner()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 458`** (2 nodes): `LiveOrderRow.tsx`, `LiveOrderRow()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 459`** (2 nodes): `sla.test.ts`, `iso()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 460`** (2 nodes): `usePoll.ts`, `usePoll()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 461`** (2 nodes): `usePoll.test.tsx`, `Probe()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 462`** (2 nodes): `test_record_audit_persists_row()`, `test_audit.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 463`** (2 nodes): `test_health()`, `test_health.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 464`** (2 nodes): `test_engine_and_service_import()`, `test_import_smoke.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 465`** (2 nodes): `test_processed_at_is_datetime()`, `test_processed_at_type.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 466`** (2 nodes): `test_preview_cache_roundtrip_and_invalidate()`, `test_preview_cache.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 467`** (2 nodes): `test_basket_and_text_share_one_conversation()`, `test_catalog_phone_normalization.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 468`** (2 nodes): `test_result_helpers()`, `test_result.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 469`** (2 nodes): `seed_partner_sandbox.py`, `main()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 470`** (2 nodes): `main()`, `enable_partner_for_test.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 471`** (2 nodes): `Router and completion-detection auxiliary prompts.  Small single-turn classifier`, `prompts_router.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 472`** (2 nodes): `Marketing auxiliary prompts.`, `prompts_marketing.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 473`** (2 nodes): `Menu, dish, segment, and forecast auxiliary prompts.  Non-conversation LLM tasks`, `prompts_menu.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 474`** (2 nodes): `current_restaurant()`, `deps.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 475`** (2 nodes): `Signature Moment: Dispatch Map Batch Lasso Animation`, `Dashboard Motion Principles (information-carrying only)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 476`** (2 nodes): `Architectural Decision: FileBlobStore (sha256-addressed, tenant-scoped) for menu PDF/image persistence`, `Architectural Decision: Greeting sends uploaded menu PDF/image as WhatsApp media (not processed text menu)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 477`** (2 nodes): `expo-notifications Plugin`, `Push Notifications Not Arriving Bug`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 478`** (2 nodes): `SLA Late-Delivery Coupon`, `Coupon Primitive (Existing)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 479`** (2 nodes): `EAS`, `Splash Screen`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 480`** (2 nodes): `app/wallet/reconcile.py + abuse.py + worker.py`, `Wallet maintenance: expiry, reconcile, abuse auto-freeze (Celery beat)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 481`** (2 nodes): `Duplicate Rider Picked Up Message Bug`, `Remove sendCurrentLocation from doPickup Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 482`** (2 nodes): `App Invite Concept`, `WhatsApp Pairing Concept`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 483`** (2 nodes): `OR-Tools default`, `SLA-first policy`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 484`** (2 nodes): `Re-add backstop`, `Multilingual order completion`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 485`** (2 nodes): `Prep-aware dispatch`, `Smart hold window`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 486`** (2 nodes): `Re-batch FSM`, `Delivery zones model`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 487`** (2 nodes): `modify_proposed`, `Option A: modify from current`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 488`** (2 nodes): `Cart Action Semantics`, `needs_clarification flag`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 489`** (2 nodes): `W7 Implementation Plan`, `Root Cause Doc (biryani-correction-flow)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 490`** (2 nodes): `F33`, `R-045`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 491`** (2 nodes): `Eval #10`, `W2+W4 routing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 492`** (2 nodes): `Branch B (note-in-dish)`, `note-in-dish regex pattern`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 493`** (2 nodes): `AMBIGUOUS dish`, `Chicken Biryani`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 494`** (1 nodes): `app.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 495`** (1 nodes): `babel.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 496`** (1 nodes): `playwright.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 497`** (1 nodes): `vite.config.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 498`** (1 nodes): `tickets-drawer.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 499`** (1 nodes): `smoke.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 500`** (1 nodes): `coupons.spec.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 503`** (1 nodes): `setup.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 504`** (1 nodes): `dispatch.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 505`** (1 nodes): `OrdersScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 506`** (1 nodes): `ConversationsScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 507`** (1 nodes): `AnalyticsScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 508`** (1 nodes): `CustomersScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 509`** (1 nodes): `CouponsScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 510`** (1 nodes): `RidersScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 511`** (1 nodes): `LiveOpsScreen.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 512`** (1 nodes): `LiveOpsScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 513`** (1 nodes): `CustomersScreen.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 514`** (1 nodes): `TicketsScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 515`** (1 nodes): `SettingsScreen.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 516`** (1 nodes): `MessageBubble.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 517`** (1 nodes): `SideDrawer.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 518`** (1 nodes): `NavSidebar.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 519`** (1 nodes): `DishCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 520`** (1 nodes): `LiveOrderRow.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 521`** (1 nodes): `DiffPanel.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 522`** (1 nodes): `LiveOpsMap.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 523`** (1 nodes): `CompactTable.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 524`** (1 nodes): `TicketDetailDrawer.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 525`** (1 nodes): `SLAOrderCard.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 526`** (1 nodes): `MessageBubble.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 527`** (1 nodes): `AppInviteModal.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 528`** (1 nodes): `DispatchKpiPanel.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 529`** (1 nodes): `StatusPill.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 530`** (1 nodes): `DiffPanel.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 531`** (1 nodes): `RiderCard.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 532`** (1 nodes): `KPITile.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 533`** (1 nodes): `CompactTable.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 534`** (1 nodes): `ChatCustomerPanel.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 535`** (1 nodes): `DispatchExplainSection.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 536`** (1 nodes): `DishCard.test.tsx`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 537`** (1 nodes): `orderDetailApi.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 538`** (1 nodes): `dispatchDisplay.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 539`** (1 nodes): `ordersApi.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 540`** (1 nodes): `auth.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 541`** (1 nodes): `orderDisplay.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 542`** (1 nodes): `types.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 543`** (1 nodes): `queryClient.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 544`** (1 nodes): `ticketsApi.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 545`** (1 nodes): `apiClient.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 546`** (1 nodes): `pollingTransport.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 547`** (1 nodes): `index.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 548`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 549`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 558`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 559`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 570`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 571`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 572`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 573`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 574`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 575`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 576`** (1 nodes): `conftest.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 577`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 578`** (1 nodes): `stop_live.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 579`** (1 nodes): `run_live.ps1`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 580`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 581`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 582`** (1 nodes): `celery_app.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 583`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 584`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 585`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 586`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 587`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 588`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 589`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 590`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 591`** (1 nodes): `Validate the loyalty config the UI sends. All numbers are non-negative;`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 592`** (1 nodes): `Validate the auto-special config: ``{enabled: bool, template_id: int|null,`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 593`** (1 nodes): `Opening hours: ``{"tz": str, "days": {"0".."6": ["HH:MM","HH:MM"]}}``.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 594`** (1 nodes): `Each tier needs a positive ascending ``max_km`` and a non-negative         ``fee`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 595`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 596`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 597`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 598`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 599`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 600`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 601`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 602`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 603`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 604`** (1 nodes): `Build the policy from a restaurant row OR its raw ``settings`` dict.          Ac`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 605`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 606`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 607`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 608`** (1 nodes): `worker.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 609`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 610`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 615`** (1 nodes): `__init__.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 616`** (1 nodes): `Both tool dicts declare only 'action' as a top-level required field.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 617`** (1 nodes): `add orders.coupon_discount_aed and orders.distance_source (W5)  W5 money & catal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 618`** (1 nodes): `Given ambiguous matches, return the single best Dish or None.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 619`** (1 nodes): `Plain-English manager override -> parsed_effect DSL dict (see adjust.py shape).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 620`** (1 nodes): `Translate plain-English audience description into a validated segment DSL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 621`** (1 nodes): `Result from the AI conversation agent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 622`** (1 nodes): `JSON-schema `properties` block shared by every provider's tool.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 623`** (1 nodes): `OpenAI / DeepSeek function-tool wrapper.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 624`** (1 nodes): `Anthropic tool-use wrapper (same properties, `input_schema` shape).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 625`** (1 nodes): `Return the list of missing mandatory field names. Empty list = OK.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 626`** (1 nodes): `Translate a canonical action+payload into (engine_action, action_data).      On`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 627`** (1 nodes): `Partial rider update — change status/duty, or edit name/phone profile fields.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 628`** (1 nodes): `A rider's most recent location ping — for the dashboard live-tracking map.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 629`** (1 nodes): `Validate the loyalty config the UI sends. All numbers are non-negative;`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 630`** (1 nodes): `Validate the auto-special config: ``{enabled: bool, template_id: int|null,`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 631`** (1 nodes): `Opening hours: ``{"tz": str, "days": {"0".."6": ["HH:MM","HH:MM"]}}``.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 632`** (1 nodes): `Each tier needs a positive ascending ``max_km`` and a non-negative         ``fee`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 633`** (1 nodes): `Send a plain-text menu when no catalogue product is sendable yet (all in review)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 634`** (1 nodes): `Raised when the Graph API rejects the catalogue read (bad token / perms / id).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 635`** (1 nodes): `Raised when pushing products to Meta fails.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 636`** (1 nodes): `Meta price format: number + space + ISO 4217 code (e.g. ``22.00 AED``).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 637`** (1 nodes): `Meta returns price as a string like 'AED30.00' (or a number). Strip any     non-`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 638`** (1 nodes): `True when WhatsApp can include this product in an interactive product_list.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 639`** (1 nodes): `Stable Content ID for a dish pushed to Meta.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 640`** (1 nodes): `Build items_batch ``data`` with Meta Commerce fields.      See https://developer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 641`** (1 nodes): `Surface per-item validation errors from an items_batch response.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 642`** (1 nodes): `Read every product in ``catalog_id`` from Meta. Raises CatalogReadError on a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 643`** (1 nodes): `Poll Meta for async items_batch ingestion status.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 644`** (1 nodes): `Wait until Meta finishes ingesting items_batch uploads (best-effort).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 645`** (1 nodes): `Push CREATE/UPDATE/DELETE batch to Meta ``/{catalog_id}/items_batch``.      Each`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 646`** (1 nodes): `Manager turning a dish's WhatsApp catalogue presence on/off.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 647`** (1 nodes): `Collapse runs of back-to-back emojis to a single emoji (no '🍽️🔥').`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 648`** (1 nodes): `Return ``{suggested_name, body, footer, examples}`` for the offer.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 649`** (1 nodes): `Mark resale sold, spawn the discounted READY order, dispatch (+ batch companion)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 650`** (1 nodes): `Verify system prompt mentions all 7 supported languages.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 651`** (1 nodes): `A PDF menu is attached as a base64 document (Claude reads it natively) —     nev`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 652`** (1 nodes): `A plain-text menu is included verbatim as a text block (not rejected).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 653`** (1 nodes): `A provider/config failure must never break ordering — degrade to haversine.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 654`** (1 nodes): `Return ≤3-line customer-facing description. NEVER include price.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 655`** (1 nodes): `Return one of: order_item | dish_question | cancel | modify | status | other.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 656`** (1 nodes): `Given ambiguous matches, return the single best Dish or None.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 657`** (1 nodes): `Plain-English manager override -> parsed_effect DSL dict (see adjust.py shape).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 658`** (1 nodes): `Translate plain-English audience description into a validated segment DSL.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 659`** (1 nodes): `Result from the AI conversation agent.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 660`** (1 nodes): `Test double: deterministic completion-intent detector.      Normalises curly/sma`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 661`** (1 nodes): `Test double: rule-based plain-English -> validated segment DSL.      Heuristics`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 662`** (1 nodes): `Extract first text block; guard truncation/empty content (error contract: Runtim`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 663`** (1 nodes): `Production describer via Claude API. Max 3 lines, never includes price.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 664`** (1 nodes): `Production intent classifier via Claude API.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 665`** (1 nodes): `Production arbiter: given ambiguous dish candidates, returns best match.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 666`** (1 nodes): `Production segment compiler: plain English -> validated DSL via haiku.      The`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 667`** (1 nodes): `Production completion detector via Claude API (haiku, yes/no prompt).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 668`** (1 nodes): `AI-powered full-conversation agent for customer ordering via WhatsApp.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 669`** (1 nodes): `OpenAI-compatible tool-calling: returns parsed arguments dict of the forced tool`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 670`** (1 nodes): `Phase-aware AI ordering assistant using DeepSeek function calling.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 671`** (1 nodes): `Production completion detector: one tiny async chat call, yes/no answer.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 672`** (1 nodes): `Mark resale sold, spawn the discounted READY order, dispatch (+ batch companion)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 673`** (1 nodes): `WhatsApp catalog ordering — a SEPARATE flow from the conversation engine.  A cus`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 674`** (1 nodes): `Catalog flow HTTP surface (manager-authed).  A small endpoint to push the WhatsA`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 675`** (1 nodes): `The products synced from this restaurant's Meta catalogue (for the OPS view).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 676`** (1 nodes): `Handle a WhatsApp catalog cart (``order`` message) → a draft order.  This is int`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 677`** (1 nodes): `Plain AED amount, trailing zeros stripped (18.00 -> "18", 18.50 -> "18.5").`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 678`** (1 nodes): `COD collection ledger (spec §4.4.4 / §3).  COD is the only payment method on the`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 679`** (1 nodes): `True if this restaurant is in catalogue ordering mode (flag on AND catalog_id se`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 680`** (1 nodes): `Append-only ledger of coupon uses — THE source of truth for limit     enforcemen`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 681`** (1 nodes): `Coupon management endpoints (manager JWT, tenant-scoped).  Campaign coupon CRUD-`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 682`** (1 nodes): `Issue a single-use coupon to a specific customer (e.g. from the chat).     Retur`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 683`** (1 nodes): `Late-delivery apology coupon service (spec §4.5).  ``issue_coupon`` mints a sing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 684`** (1 nodes): `A grouped set of orders assigned to one rider for sequential delivery.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 685`** (1 nodes): `Proactively message the customer on kitchen/delivery progress (preparing,     pi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 686`** (1 nodes): `Dispatch endpoints — trigger + assignment explainability (spec §4.3, §5.6).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 687`** (1 nodes): `Active batch polylines and SLA pressure rings for the live ops map.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 688`** (1 nodes): `Dispatch API schemas.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 689`** (1 nodes): `Auto-dispatch engine (spec §4.3).  Behaviour:   * Eligible set = orders ``status`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 690`** (1 nodes): `Load unassigned preview-eligible orders using the same pool as ``_dispatch``.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 691`** (1 nodes): `Periodic dispatch sweep (Celery beat).  Runs the dispatch engine for every resta`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 692`** (1 nodes): `FastAPI/Celery dependency. Returns FakeGeoProvider or GoogleMapsGeoProvider.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 693`** (1 nodes): `Rewrite em/en/standalone-hyphen separators in an AI reply as commas.      Compou`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 694`** (1 nodes): `Loyalty program — tiers (Phase 1) + earn-as-wallet-credit (Phase 2).  Everything`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 695`** (1 nodes): `Celery beat: nightly loyalty tier recompute across all tenants.  Per restaurant`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 696`** (1 nodes): `Marketing REST API — templates, segments, campaigns, analytics.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 697`** (1 nodes): `Delete a template — removes it from Meta (best-effort) and hides it from the`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 698`** (1 nodes): `Pydantic v2 request/response schemas for the Marketing REST API.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 699`** (1 nodes): `Marketing orchestration service (spec §4.7, plan Task 15).  The layer that wires`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 700`** (1 nodes): `Celery marketing workers — scheduled campaign dispatch (P6-T19).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 701`** (1 nodes): `Return the currently active menu with all dishes for this restaurant.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 702`** (1 nodes): `Re-run extraction on stored file bytes and return a new draft + diff.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 703`** (1 nodes): `In-memory push provider for tests/dev — records sends, never hits the network.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 704`** (1 nodes): `Observability package (metrics, middleware re-exports).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 705`** (1 nodes): `Open Knowledge Format (OKF) store.  OKF (https://cloud.google.com/blog/products/`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 706`** (1 nodes): `True only when the buyer's phone AND door/apartment AND building AND pinned`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 707`** (1 nodes): `Convert common Markdown to WhatsApp formatting (idempotent).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 708`** (1 nodes): `Flush all pending outbox rows for a restaurant (best-effort).      For request h`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 709`** (1 nodes): `Atomically claim a restaurant's pending outbox rows for dispatch.      Transitio`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 710`** (1 nodes): `Partner integration API.  Two surfaces:   * ``/api/v1/api-keys`` — manager-authe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 711`** (1 nodes): `List this restaurant's keys (active + revoked), newest first. Never the     secr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 712`** (1 nodes): `Pydantic I/O schemas for the partner integration API.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 713`** (1 nodes): `Predictions REST API — forecast runs, prep-ahead suggestions, manager overrides.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 714`** (1 nodes): `Celery ML workers — nightly forecast across all tenants (P6-T19); weekly retrain`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 715`** (1 nodes): `Records yellow/red/breach SLA alerts for an order.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 716`** (1 nodes): `Complaint ticket model.  A complaint is HUMAN-handled only: the AI may open a ti`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 717`** (1 nodes): `Complaint ticket endpoints (manager JWT, tenant-scoped).  Managers list/inspect`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 718`** (1 nodes): `Ticket service — complaint capture + the three manager resolution actions.  The`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 719`** (1 nodes): `Window-aware customer notification: session text inside 24h, else the     approv`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 720`** (1 nodes): `Wallet read endpoints (manager JWT, tenant-scoped).  Balance/history are read-on`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 721`** (1 nodes): `Wallet service — the ONLY place wallet value moves.  All balances are derived fr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 722`** (1 nodes): `Celery beat tasks for wallet maintenance: credit expiry + reconciliation.  Both`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 723`** (1 nodes): `Singleton MockProvider shared across the process — enables simulator access.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 724`** (1 nodes): `Minimal restaurant row for the catalog flow's FKs (phone matches the     test in`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 725`** (1 nodes): `Unified menu: menu requests prefer catalogue cards, but fall back to the real`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 726`** (1 nodes): `order_confirmation confirm button finalizes the order with totals + ETA.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 727`** (1 nodes): `Tests for dispatch HTTP endpoints (spec §4.3, §5.6).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 728`** (1 nodes): `A,B,A,D,B,A — corridor cluster (D far) stays SLA-safe; D rides solo.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 729`** (1 nodes): `Seed a minimal restaurant row for opt-out FK references.      Dynamic-PK: tests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 730`** (1 nodes): `Marketing REST API router tests.  Uses the shared ``client`` + ``auth_headers```
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 731`** (1 nodes): `Marketing service — campaigns, template submit, compliant send, analytics.  The`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 732`** (1 nodes): `Tests for the marketing Celery worker (marketing.send_scheduled_campaigns).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 733`** (1 nodes): `No due campaigns — _dispatch_scheduled must complete without error.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 734`** (1 nodes): `Seed a minimal restaurant row required for ordering FKs.      Non-autouse and dy`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 735`** (1 nodes): `AND gate: barred ONLY when phone + door/apartment + building + pin ALL match.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 736`** (1 nodes): `An over-large limit is clamped to 100 (never returns more than 100 rows).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 737`** (1 nodes): `Cancel an order.      Before cooking (status != preparing) → plain transition to`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 738`** (1 nodes): `Build items_batch ``data`` with Meta Commerce required fields.      See https://`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 739`** (1 nodes): `Show the menu under the restaurant's STRICT mode (catalogue OR text, no mixing).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 740`** (1 nodes): `Returning customer → offer the saved address UP FRONT with Use/New buttons,`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 741`** (1 nodes): `Push local dishes to the restaurant's Meta catalogue.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 742`** (1 nodes): `True for short, explicit 'show me the menu' messages (lowercased).      Kept tig`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 743`** (1 nodes): `Lowercase + strip punctuation/emoji/extra spaces so "No.", "Np!", and     "That'`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 744`** (1 nodes): `Push local dishes (without Meta link) to the restaurant's Meta catalogue.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 745`** (1 nodes): `Pull from Meta, link dishes, then push any dish-only items to Meta.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 746`** (1 nodes): `Latest (lat, lon) ping per rider from rider_locations.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 747`** (1 nodes): `Download a WhatsApp voice note and transcribe it to text. Returns the     transc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 748`** (1 nodes): `Cancel an order. Legal before delivery only: draft/pending/confirmed →     cance`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 749`** (1 nodes): `Best-effort per-restaurant lock. No-op if redis unavailable (tests).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 750`** (1 nodes): `+10 min per *additional* batched stop beyond the first.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 751`** (1 nodes): `Send the rider the next stop: nav link + Delivered button (COD-aware).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 752`** (1 nodes): `Rider pressed "Orders Picked": advance the whole batch and send stop #1.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 753`** (1 nodes): `Send the rider the next stop: nav link + Delivered button (COD-aware).     If ne`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 754`** (1 nodes): `Return True if this buyer (phone + person/address) is barred from this resale pe`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 755`** (1 nodes): `Resale-offer matcher: returns on_resale orders for which the given buyer is NOT`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 756`** (1 nodes): `Assemble the TEMPLATE outbox payload (name, language, components).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 757`** (1 nodes): `Send nudges for stale draft carts. Returns the number of nudges enqueued.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 758`** (1 nodes): `Render the active menu as categorized text.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 759`** (1 nodes): `Render order summary with totals + ETA and confirm/cancel buttons.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 760`** (1 nodes): `Find and add a dish; return True if successfully added.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 761`** (1 nodes): `Remove matching dish from draft order cart.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 762`** (1 nodes): `Update quantity of matching dish in draft order.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 763`** (1 nodes): `Cancel the current draft/pending order.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 764`** (1 nodes): `Process a location pin in address_capture phase.      Validates against restaura`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 765`** (1 nodes): `Conversations Fixture Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 766`** (1 nodes): `Orders Fixture Data`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 767`** (1 nodes): `Frontend TypeScript Config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 768`** (1 nodes): `Playwright Last Run Result`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 769`** (1 nodes): `Test: _run_retrains completes for restaurant`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 770`** (1 nodes): `Business Rule: SLA breach_40 without weather delay issues coupon (AED 10)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 771`** (1 nodes): `Business Rule: SLA breach_40 with weather_delay_disclosed skips coupon`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 772`** (1 nodes): `Business Rule: SLA monitor is idempotent (no duplicate SlaEvent rows)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 773`** (1 nodes): `Business Rule: yellow_30 enqueues manager alert outbox message`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 774`** (1 nodes): `Business Rule: breach_40 enqueues customer alert outbox message`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 775`** (1 nodes): `Risk: Celery FK resolution failure causes duplicate WhatsApp messages`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 776`** (1 nodes): `Platform Actors`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 777`** (1 nodes): `WhatsApp Throughput Limits`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 778`** (1 nodes): `Marketing Segment DSL`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 779`** (1 nodes): `Redis Token-Bucket Rate Limiter`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 780`** (1 nodes): `Google Maps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 781`** (1 nodes): `Claude AI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 782`** (1 nodes): `push_token (concept)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 783`** (1 nodes): `Phase A (push notifications + app-driven actions)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 784`** (1 nodes): `Goal: native app primary, WhatsApp fallback`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 785`** (1 nodes): `Pairing code (WhatsApp one-time code)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 786`** (1 nodes): `Device token (long-lived auth)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 787`** (1 nodes): `Background GPS tracking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 788`** (1 nodes): `Fix Double GPS Ping`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 789`** (1 nodes): `POST_NOTIFICATIONS Permission`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 790`** (1 nodes): `shadow mode`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 791`** (1 nodes): `re-optimization`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 792`** (1 nodes): `SLA constraint`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 793`** (1 nodes): `cost tiebreak`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 794`** (1 nodes): `best-effort partial`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 795`** (1 nodes): `priority orders`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 796`** (1 nodes): `re-optimization`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 797`** (1 nodes): `shadow mode`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 798`** (1 nodes): `dispatch metrics`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 799`** (1 nodes): `Outbox`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 800`** (1 nodes): `LiveOps dispatch map`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 801`** (1 nodes): `GPS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 802`** (1 nodes): `Duplicate Customer Message Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 803`** (1 nodes): `Delivered Stop Stuck Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 804`** (1 nodes): `Rider App-Only Mode`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 805`** (1 nodes): `Rider Actions Module Extraction`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 806`** (1 nodes): `Pickup Live Location Gate Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 807`** (1 nodes): `Native App Pairing Branch`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 808`** (1 nodes): `Splash Screen Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 809`** (1 nodes): `UTCNow Deprecation Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 810`** (1 nodes): `Test Runner Subagent / Coverage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 811`** (1 nodes): `Google Maps Geo Provider`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 812`** (1 nodes): `Resale Exclusion Helper`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 813`** (1 nodes): `APP_MARKETING_TICK_SECRET`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 814`** (1 nodes): `APP_OUTBOX_SYNC_DELIVERY`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 815`** (1 nodes): `External Cron Job`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 816`** (1 nodes): `Atomic Claim Issue`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 817`** (1 nodes): `web tracker CTA`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 818`** (1 nodes): `device token check`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 819`** (1 nodes): `Customer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 820`** (1 nodes): `GPS Tracking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 821`** (1 nodes): `Expo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 822`** (1 nodes): `device_token`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 823`** (1 nodes): `Referral Loop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 824`** (1 nodes): `WalletEntry Ledger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 825`** (1 nodes): `Coupon (Generalized)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 826`** (1 nodes): `Double-Entry Ledger`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 827`** (1 nodes): `Firebase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 828`** (1 nodes): `FCM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 829`** (1 nodes): `WhatsApp pairing`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 830`** (1 nodes): `live-location gate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 831`** (1 nodes): `app-only rider flow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 832`** (1 nodes): `POST /api/v1/riders endpoint`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 833`** (1 nodes): `push notification concept`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 834`** (1 nodes): `Rider Onboarding`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 835`** (1 nodes): `Live GPS Tracking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 836`** (1 nodes): `Firebase Cloud Messaging (FCM)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 837`** (1 nodes): `Push Notification Flow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 838`** (1 nodes): `WhatsApp Messaging Flow`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 839`** (1 nodes): `Rider Goes App-Only Feature`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 840`** (1 nodes): `LiveOps Dispatch Map Enhancement`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 841`** (1 nodes): `ops`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 842`** (1 nodes): `background GPS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 843`** (1 nodes): `Render`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 844`** (1 nodes): `Spend-Threshold Cashback`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 845`** (1 nodes): `rider APK artifact`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 846`** (1 nodes): `Ops Terminal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 847`** (1 nodes): `Order`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 848`** (1 nodes): `Pairing Mechanism`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 849`** (1 nodes): `Background GPS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 850`** (1 nodes): `device_token concept`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 851`** (1 nodes): `rider_app_apk_url config`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 852`** (1 nodes): `app-invite`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 853`** (1 nodes): `FSM (Finite State Machine)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 854`** (1 nodes): `COD (Cash on Delivery)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 855`** (1 nodes): `Expo Push API`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 856`** (1 nodes): `Web Tracker`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 857`** (1 nodes): `Extract Transport-Agnostic Rider Actions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 858`** (1 nodes): `Fix Pickup Live Location Gate`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 859`** (1 nodes): `Fix Push Notifications Not Arriving`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 860`** (1 nodes): `Fix Delivered Stop Stays on Screen`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 861`** (1 nodes): `rider.device_token`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 862`** (1 nodes): `Batch`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 863`** (1 nodes): `COD`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 864`** (1 nodes): `UAT Checklist`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 865`** (1 nodes): `LiveOps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 866`** (1 nodes): `Rider Pairing (Code + APK)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 867`** (1 nodes): `Routes API`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 868`** (1 nodes): `Explainability payload`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 869`** (1 nodes): `Re-add backstop`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 870`** (1 nodes): `Fake agent closing parity`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 871`** (1 nodes): `Greedy fallback`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 872`** (1 nodes): `Prep-aware batching`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 873`** (1 nodes): `Manual delivery zones`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 874`** (1 nodes): `Re-batch until pickup`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 875`** (1 nodes): `Manager explainability`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 876`** (1 nodes): `Dispatch presets`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 877`** (1 nodes): `Re-batch`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 878`** (1 nodes): `Transcript replay driver.  Drives a list of turn dicts through the real ``handle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 879`** (1 nodes): `Drive *turns* through the real handle_inbound and return a TranscriptResult.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 880`** (1 nodes): `Smoke test for the transcript replay driver.  Uses the same db_session / restaur`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 881`** (1 nodes): `drive_turns: one text turn must produce ≥1 outbound and a cart with biryani.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 882`** (1 nodes): `MessageType`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 883`** (1 nodes): `draft cart`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 884`** (1 nodes): `post_order phase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 885`** (1 nodes): `biryani correction root cause doc`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 886`** (1 nodes): `platform design spec 2026-06-06`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 887`** (1 nodes): `remediation design 2026-06-30`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 888`** (1 nodes): `full order cancel behavior`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 889`** (1 nodes): `partial cancellation gap`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 890`** (1 nodes): `history limit=10`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 891`** (1 nodes): `_ORDERING_BLOCK`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 892`** (1 nodes): `Option B: inline post-confirm edit`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 893`** (1 nodes): `Option C: unified ConversationActionPort`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 894`** (1 nodes): `_CONFIRMATION_BLOCK`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 895`** (1 nodes): `partial-item-cancellation-analysis.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 896`** (1 nodes): `Dish-level remove/cancel, not whole-order cancel.      'Cancel chicken soup from`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 897`** (1 nodes): `Customer wants the bot to apply a pending change without retyping dishes.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 898`** (1 nodes): `Snapshot current order lines into a serializable modify_proposed list.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 899`** (1 nodes): `Stable tuple for comparing proposed vs baseline.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 900`** (1 nodes): `Resolve a dish query to an index in modify_proposed (order snapshot names).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 901`** (1 nodes): `Remove units from one proposed line. Returns (new_list, dish_name, fully_removed`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 902`** (1 nodes): `Remove a dish from modify_proposed. Returns (success, dish_name).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 903`** (1 nodes): `Seed the four dishes used by the biryani capability evals.      Each dish is ava`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 904`** (1 nodes): `Capability eval — RA-7 / F49 / RA-5: biryani correction incident.  A customer se`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 905`** (1 nodes): `Response-accuracy capability eval suite — 19 scenarios (W0).  All xfail evals ru`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 906`** (1 nodes): `Catalog basket with biryani, then 'Need double masala in biriyani'.     Engine t`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 907`** (1 nodes): `Customer adds 1 chicken biryani then says 'make it 2 chicken biryani'.     Engin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 908`** (1 nodes): `Add 2 lemon mints then 'remove 1 lemon mint'.  Today the engine either     dupli`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 909`** (1 nodes): `make it 1 lakh' after adding lemon mint.  The engine today silently     accepts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 910`** (1 nodes): `A 'reaction' arrives as UNKNOWN type.  Today the engine falls through to     the`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 911`** (1 nodes): `catlog' (common typo) is NOT in _MENU_KEYWORDS today, so it falls through     to`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 912`** (1 nodes): `pls add extra masala' after ordering biryani.  The engine today either     store`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 913`** (1 nodes): `Cart has biryani + lemon mint. 'only 1 biryani' means set biryani qty to 1;`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 914`** (1 nodes): `The engine layer has no deduplication gate (that lives in the webhook router).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 915`** (1 nodes): `Why did you add 2 biriyani' must not mutate the cart.     CONVERTED FROM XFAIL:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 916`** (1 nodes): `After adding an item, 'That's all' must advance dialogue out of ordering.     CO`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 917`** (1 nodes): `Do you have my saved address?' with no address in DB — bot must deny.     CONVER`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 918`** (1 nodes): `Arabic question 'ما هو أفضل طبق؟' must not dump an invented English dish list.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 919`** (1 nodes): `grade_total_consistency must pass for a basic cart (total ≥ subtotal).     CONVE`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 920`** (1 nodes): `Two separate carts must get different order numbers.     CONVERTED FROM XFAIL: s`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 921`** (1 nodes): `Subtotal must equal sum of line prices for a basic two-item cart.     CONVERTED`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 922`** (1 nodes): `CHICKEN BIRYANI' (all-caps) must resolve to the seeded dish.     CONVERTED FROM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 923`** (1 nodes): `menu' must update dialogue_state to 'menu_sent'.     CONVERTED FROM XFAIL: engin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 924`** (1 nodes): `show me the full menu' must not produce invented dish names.     CONVERTED FROM`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 925`** (1 nodes): `menu' keyword must trigger send_catalog and enqueue a product_list.      After I`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 926`** (1 nodes): `# NOTE: Fake-scoped guard. Passes because FakeConversationAgent does not reprodu`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 927`** (1 nodes): `CLAUDE.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 928`** (1 nodes): `LLM Response Accuracy Issue`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 929`** (1 nodes): `Rider App Fixes (doPickup, push notifications, GPS)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 930`** (1 nodes): `DB-H14`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 931`** (1 nodes): `Create the W7 branch`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 932`** (1 nodes): `Add the 3 W7 capability evals (xfail-strict)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 933`** (1 nodes): `Self-review, full matrix, ruff, graphify, understanding.txt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 934`** (1 nodes): `cart_state (structured array)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 935`** (1 nodes): `Contract tests for the canonical conversation action schema (W1).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 936`** (1 nodes): `Single source of truth for the conversation action (LLM tool) schema (W1).  Ever`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 937`** (1 nodes): `JSON-schema `properties` block shared by every provider's tool.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 938`** (1 nodes): `OpenAI / DeepSeek function-tool wrapper.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 939`** (1 nodes): `Anthropic tool-use wrapper (same properties, `input_schema` shape).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 940`** (1 nodes): `Return the list of missing mandatory field names. Empty list = OK.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 941`** (1 nodes): `Translate a canonical action+payload into (engine_action, action_data).      On`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 942`** (1 nodes): `_DS_TOOL must be derived from the canonical action_schema module.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 943`** (1 nodes): `cart_set_qty without new_total must be blocked (no cart mutation).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 944`** (1 nodes): `cart_set_qty with new_total maps to legacy update_qty with correct qty.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 945`** (1 nodes): `Behavioral constraints (frustration/re-add) must be in the ordering system promp`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 946`** (1 nodes): `Round-trip: Claude returns canonical 'cart_add' -> respond() yields legacy 'add_`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 947`** (1 nodes): `only 1 chicken biryani' must emit update_qty (cart_set_qty), NOT add_item.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 948`** (1 nodes): `make it 4 biryani' must emit update_qty (cart_set_qty), NOT add_item.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 949`** (1 nodes): `2 biryani' must emit add_item (cart_add delta), NOT update_qty.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 950`** (1 nodes): `Every Fake output must be a clean engine-legacy result, never a raw canonical di`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 951`** (1 nodes): `address' contains 'add' as substring — must NOT yield add_item at confirm phase.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 952`** (1 nodes): `don't add more' is a refusal, not a cart_add command.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 953`** (1 nodes): `Provider-parity contract: DeepSeek, Claude, Fake expose ONE action surface (W1).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 954`** (1 nodes): `Properties block extracted from DeepSeek's live OpenAI tool dict.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 955`** (1 nodes): `Properties block extracted from Claude's live Anthropic tool dict.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 956`** (1 nodes): `Both provider tool dicts enumerate exactly the canonical action set.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 957`** (1 nodes): `DeepSeek and Claude expose the same top-level property names.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 958`** (1 nodes): `The items[].op enum is identical in both providers and matches the spec.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 959`** (1 nodes): `validate_required() recognises all canonical actions and returns sane data.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 960`** (1 nodes): `Explicit qty fields exist; the legacy overloaded 'qty' top-level field is gone.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 961`** (1 nodes): `CANON_PHASE_ACTIONS maps cleanly to LEGACY_PHASE_ACTIONS via CANON_TO_LEGACY.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 962`** (1 nodes): `FakeConversationAgent is structurally bound to the canonical schema.      Verifi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 963`** (1 nodes): `FakeConversationAgent behavioural check: every emitted action is in CANON_TO_LEG`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 964`** (1 nodes): `Both tool dicts declare only 'action' as a top-level required field.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 965`** (1 nodes): `Tests for W1 Task 6: clarification gate + derived phase-action table.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 966`** (1 nodes): `A model result flagged needs_clarification must NOT mutate the cart and must`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 967`** (1 nodes): `When result.message is set, the clarification reply uses THAT text (not the`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 968`** (1 nodes): `The derived _PHASE_ACTIONS must be a superset of the old hand-written literal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 969`** (1 nodes): `A set-qty intent without a quantity must not change the cart and must ask a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 970`** (1 nodes): `W2 cart-line identity tests.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 971`** (1 nodes): `Re-adding a dish with a note must update the existing line's note, not create a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 972`** (1 nodes): `cart_set_qty`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 973`** (1 nodes): `requires_one_of`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 974`** (1 nodes): `no_action`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 975`** (1 nodes): `needs_clarification`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 976`** (1 nodes): `new_total`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 977`** (1 nodes): `regression`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 978`** (1 nodes): `Changing qty must preserve the kitchen note (RA-7/R-006).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 979`** (1 nodes): `modify_order must carry variant_name and notes from new_items, not silently stri`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 980`** (1 nodes): `CartService — single owner of cart mutations for ordering.  All add / set-qty /`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 981`** (1 nodes): `Strip politeness/action prefixes from a kitchen note before storing.      'pls a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 982`** (1 nodes): `Structured representation of one cart line for LLM context injection.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 983`** (1 nodes): `Facade over the ordering service functions.      All callers (conversation engin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 984`** (1 nodes): `Add or merge a dish into the cart (delegates to service.add_item).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 985`** (1 nodes): `Set exact quantity, preserving notes (delegates to service.set_item_qty).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 986`** (1 nodes): `Apply a normalised kitchen note to an in-cart dish.          Strips politeness/a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 987`** (1 nodes): `Remove units of a dish from the cart.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 988`** (1 nodes): `Delete ALL items from the cart.          Raises ValueError when *explicit* is Fa`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 989`** (1 nodes): `Return structured cart lines with stable cart_item_id for LLM context (F64).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 990`** (1 nodes): `set_note must strip politeness prefixes before storing (F101/TX-30).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 991`** (1 nodes): `clear() must raise ValueError when explicit=False (F82).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 992`** (1 nodes): `build_structured_context must return CartLineContext with cart_item_id (F64).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 993`** (1 nodes): `_build_context must inject cart_lines (CartLineContext list) in ordering phase (`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 994`** (1 nodes): `A voice note naming 5 items.  Without audio_id the harness cannot reach     Fake`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 995`** (1 nodes): `w2-finish-report.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 996`** (1 nodes): `W2 Fix`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 997`** (1 nodes): `cart unchanged (qty == 2), reply contains clarification keyword`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 998`** (1 nodes): `W2 contract (R-002 / RA-4): a dish merges to ONE line per (dish_id, variant_name`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 999`** (1 nodes): `Pure DB renderer for cart and order summary (W3/RA-1/R-013/R-040).  Renders cart`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1000`** (1 nodes): `Format a money value as a plain AED amount string.      Identical logic to engin`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1001`** (1 nodes): `Render an order item's special-note suffix (identical to engine._note_suffix).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1002`** (1 nodes): `Return a DB-backed cart/summary string for the given order and dialogue phase.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1003`** (1 nodes): `Render the \\n\\n🛒 cart tail for the ordering phase (mirrors engine._cart_tail).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1004`** (1 nodes): `Render the full order-summary text body for the awaiting_confirmation phase.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1005`** (1 nodes): `Pure DB renderer tests (W3/RA-1/R-013).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1006`** (1 nodes): `ordering phase: result starts with \\n\\n🛒, contains dish name and subtotal.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1007`** (1 nodes): `awaiting_confirmation phase: result contains order summary fields.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1008`** (1 nodes): `ordering phase with no items → '\\n\\n🛒 Your cart is now empty.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1009`** (1 nodes): `W3 render gate tests — DB-backed cart tail + factual validator (RA-1/R-013/R-040`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1010`** (1 nodes): `drive 'one chicken biryani' → outbound body must contain 🛒, dish name, Subtotal.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1011`** (1 nodes): `drive add then note update → outbound body must contain 🛒 and Subtotal.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1012`** (1 nodes): `After cart → 'done', the engine advances the flow with an engine-authored     me`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1013`** (1 nodes): `When an order is confirmed, the confirmation carries a DB order_number, never`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1014`** (1 nodes): `Record a compact DB-derived cart observation into message history after any`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1015`** (1 nodes): `After a single add, a cart_observation Message must exist in DB (F66/W3).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1016`** (1 nodes): `Remove lines that contain an AED amount from LLM free text on mutating turns.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1017`** (1 nodes): `_strip_money_claims removes lines containing an AED amount (R-067).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1018`** (1 nodes): `_strip_money_claims keeps lines without a currency amount.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1019`** (1 nodes): `_strip_money_claims handles empty and None input.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1020`** (1 nodes): `Production W4 top-level router via Claude API (single enum, multilingual).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1021`** (1 nodes): `Production W4 top-level router: one async chat call, single enum answer.      LL`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1022`** (1 nodes): `W4 top-level multilingual intent router (LLM-driven; Fake for tests).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1023`** (1 nodes): `Top-level multilingual router intent (W4).      A single, phase-aware, language-`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1024`** (1 nodes): `Top-level multilingual intent router (W4).      LLM-driven and language-agnostic`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1025`** (1 nodes): `Deterministic test double for the W4 top-level multilingual router.  The product`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1026`** (1 nodes): `Rule-based, deterministic ``RouterClassifierPort`` test double.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1027`** (1 nodes): `W4 Task 1 — top-level multilingual intent router: port + Fake impl.  The Fake is`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1028`** (1 nodes): `W4 top-level multilingual router: classify the customer's latest text turn.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1029`** (1 nodes): `W4 Task 5 — global read-only intents work inside a modify sub-flow.  F103/TX-28/`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1030`** (1 nodes): `biryani-fix-report.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1031`** (1 nodes): `DIRECT dish`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1032`** (1 nodes): `Mutton Biryani`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1033`** (1 nodes): `W5 capability evals — Money & catalogue price integrity.  Five behaviours the re`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1034`** (1 nodes): `Re-derive ``order.total`` from persisted items + fee + coupon + wallet.      The`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1035`** (1 nodes): `Validate + redeem ``coupon_code`` against ``order`` and re-apply the total.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1036`** (1 nodes): `One per-line quantity policy for every order path (typed, catalogue, modify).  A`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1037`** (1 nodes): `Raised when a single line's quantity is outside the allowed range.      ``qty```
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1038`** (1 nodes): `Immutable per-line quantity bounds for one restaurant.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1039`** (1 nodes): `Build the policy from a restaurant row OR its raw ``settings`` dict.          Ac`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1040`** (1 nodes): `Return ``qty`` if within ``1..max_item_qty``; else raise ``QuantityError``.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1041`** (1 nodes): `Distance (km) restaurant → customer + the SOURCE it was derived from.      Retur`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1042`** (1 nodes): `w5-report.md`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1043`** (1 nodes): `is_only_intent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1044`** (1 nodes): `note-in-dish pattern`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1045`** (1 nodes): `RA-7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1046`** (1 nodes): `AMBIGUOUS fallback`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1047`** (1 nodes): `Graduation rule`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1048`** (1 nodes): `W6 capability evals — Menu / availability single source of truth.  Five behaviou`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1049`** (1 nodes): `Body of the most-recent outbound Message inserted after *after_id*.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1050`** (1 nodes): `Seed a restaurant with ONLY Chicken Biryani — nothing else.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1051`** (1 nodes): `A model reply listing >=2 dish-like names NOT in the catalogue must be replaced.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1052`** (1 nodes): `In a single-dish restaurant, the cross-check must flag a reply that names     di`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1053`** (1 nodes): `A dish with whatsapp_enabled=False must not appear in _render_menu output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1054`** (1 nodes): `A customer cannot order a whatsapp_enabled=False dish via text.      Covers TX-4`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1055`** (1 nodes): `In catalogue mode, ordering a text-menu dish with no active CatalogProduct must`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1056`** (1 nodes): `A dish whose name matches ^[a-z][a-z0-9_]*$ (slug pattern) must not appear in`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1057`** (1 nodes): `Dashboard Data Latency Design`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1058`** (1 nodes): `Return the normalised canonical dish names for the tenant.      In catalogue mod`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1059`** (1 nodes): `True if the LLM reply appears to list dishes NOT in the tenant's catalogue.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1060`** (1 nodes): `Tenant-scoped TTL cache for ``preview_batch_groups`` results.  Batch preview run`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1061`** (1 nodes): `Drop cached labels when dispatch pool changes (assign, ready, cancel).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1062`** (1 nodes): `API response timing — surfaces slow dashboard paths on Render.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1063`** (1 nodes): `Parse ``?include=`` for order detail. None means all sections.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1064`** (1 nodes): `Assemble order detail for the manager drawer.      ``includes=None`` loads every`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1065`** (1 nodes): `W2 T6/T7/T8`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1066`** (1 nodes): `CANON_PHASE_ACTIONS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1067`** (1 nodes): `LEGACY_PHASE_ACTIONS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1068`** (1 nodes): `CANON_TO_LEGACY`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1069`** (1 nodes): `claude_conversation_enabled`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1070`** (1 nodes): `Onboarding Status API`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1071`** (1 nodes): `True when ``dish`` must never be shown/ordered on WhatsApp.      Two independent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1072`** (1 nodes): `_execute_ai_add_item`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1073`** (1 nodes): `_handle_collecting_items`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1074`** (1 nodes): `Phone Ordering Reply`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1075`** (1 nodes): `Workstream W5`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1076`** (1 nodes): `Guard F20-A`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1077`** (1 nodes): `Guard F26`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1078`** (1 nodes): `Guard F31`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1079`** (1 nodes): `Guard F41`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1080`** (1 nodes): `Guard F74`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1081`** (1 nodes): `Guard F97`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1082`** (1 nodes): `Guard F98`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1083`** (1 nodes): `Guard F103`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1084`** (1 nodes): `Guard R-069`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1085`** (1 nodes): `Guard R-051`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1086`** (1 nodes): `Guard R-049`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1087`** (1 nodes): `Guard R-050`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1088`** (1 nodes): `Guard R-026`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1089`** (1 nodes): `Guard R-023`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1090`** (1 nodes): `Guard R-019`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1091`** (1 nodes): `Guard TX-45`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1092`** (1 nodes): `Guard TX-06`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1093`** (1 nodes): `Guard TX-28`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1094`** (1 nodes): `Guard TX-39`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1095`** (1 nodes): `Render one stored Message into LLM-readable content. Covers every     Message.ty`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1096`** (1 nodes): `Single source of truth for LLM conversation history.      Fetches the last `limi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1097`** (1 nodes): `List orders for the tenant, newest first, with optional server-side filters.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1098`** (1 nodes): `Older rows without a display_text/cart_snapshot still render human text,     nev`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1099`** (1 nodes): `_fetch_conversation_history was already deleted in W1 (b9ae270); guard     again`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1100`** (1 nodes): `Server-side order list filters (date range, search, offset).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1101`** (1 nodes): `List orders endpoint must stay within dashboard latency budget.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1102`** (1 nodes): `50 seeded orders + mocked planner — hot list path stays under 250 ms.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1103`** (1 nodes): `Start of a Dubai calendar day as naive UTC (matches DB ``created_at`` storage).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1104`** (1 nodes): `Start of the next Dubai calendar day as naive UTC (exclusive upper bound).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1105`** (1 nodes): `W0 Task 4`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1106`** (1 nodes): `Branch B`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1107`** (1 nodes): `Only Intent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1108`** (1 nodes): `After a catalogue basket, _build_history must show the resolved dish names     f`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1109`** (1 nodes): `The interpreter receives context['cart_state'] (a structured array) and is     t`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1110`** (1 nodes): `Every customer-facing outbound is recorded in `messages` (DB-H3/4/5).     Drive`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1111`** (1 nodes): `W7`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1112`** (1 nodes): `W7a`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1113`** (1 nodes): `W7b`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1114`** (1 nodes): `R-051`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1115`** (1 nodes): `R-019`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1116`** (1 nodes): `R-049`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1117`** (1 nodes): `R-029`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1118`** (1 nodes): `R-077`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1119`** (1 nodes): `F63`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1120`** (1 nodes): `DB-H8`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1121`** (1 nodes): `R-072`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1122`** (1 nodes): `R-074`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1123`** (1 nodes): `R-060`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1124`** (1 nodes): `DB-H3`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1125`** (1 nodes): `DB-H4`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1126`** (1 nodes): `DB-H5`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1127`** (1 nodes): `engine.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1128`** (1 nodes): `Task 2 (W7a)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1129`** (1 nodes): `Task 4 (W7a)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1130`** (1 nodes): `Task 7 (W7a)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1131`** (1 nodes): `Note-in-dish Pattern`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1132`** (1 nodes): `History Faithfulness`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1133`** (1 nodes): `Structured Context`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1134`** (1 nodes): `W8 — State/flow correctness & ops hardening.  Task 1: confirm_order / cancel_ord`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1135`** (1 nodes): `Any call proves the button path took an LLM round-trip — which it must not.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1136`** (1 nodes): `R-008: an out-of-range pin clears only pin/fee state, never the cart.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1137`** (1 nodes): `TX-02: resume → continue → 'that's all' must advance to checkout, never     read`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1138`** (1 nodes): `Create a draft order with a unique, atomically-allocated per-tenant order number`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1139`** (1 nodes): `TX-14/F114: a greeting/status message after confirmation must never mark     the`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1140`** (1 nodes): `W8/TX-13/F114: the DB must reject a duplicate order_number for the same     tena`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1141`** (1 nodes): `W8/TX-13/F114: repeated allocation under a simulated race (count() read     befo`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1142`** (1 nodes): `Serialize inbound processing per (restaurant, phone) thread (TX-22/TX-46/F94/F11`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 1143`** (1 nodes): `TX-22/TX-46/F94/F115: two 'simultaneous' inbound messages for the same     conve`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **What is the exact relationship between `Coupon` and `Coupon`?**
  _Edge tagged AMBIGUOUS (relation: conceptually_related_to) - confidence is low._
- **Why does `Restaurant` connect `Community 1` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 138`, `Community 13`, `Community 14`, `Community 15`, `Community 16`, `Community 273`, `Community 18`, `Community 25`, `Community 44`, `Community 174`, `Community 177`, `Community 315`, `Community 190`, `Community 196`, `Community 76`, `Community 209`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `Order` connect `Community 0` to `Community 1`, `Community 257`, `Community 4`, `Community 5`, `Community 294`, `Community 7`, `Community 74`, `Community 75`, `Community 14`, `Community 15`, `Community 16`, `Community 177`, `Community 18`, `Community 21`, `Community 25`, `Community 190`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `Customer` connect `Community 0` to `Community 160`, `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 72`, `Community 74`, `Community 14`, `Community 15`, `Community 209`, `Community 177`, `Community 114`, `Community 273`, `Community 18`, `Community 315`, `Community 190`?**
